/**
 * Build script (Node): aggregates the per-episode transcripts into per-season,
 * per-episode character dialogue, written to
 * data/frasier_transcripts/characters_by_episode.json (used for the per-character
 * appearance tables). Run with `node lib/process_by_episode.js`.
 */
const fs = require("fs");
