 ...
 * character dialogue, written to data/characters_by_season.json (used by the
 * StackedBarchart and the word/phrase clouds). Run from the project root with
 * `node lib/process_by_season.js`.
 */
const fs = require("fs");
