/**
 * Build script (Node): aggregates every per-episode transcript into each
 * character's dialogue across the whole series, written to
 * data/character_data_whole_season.json (used by the Barchart). Run from the
 * project root with `node lib/process_all_season.js`.
 */
const fs = require("fs");
