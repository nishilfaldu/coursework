 ...
 *
 * Wires up the page: handles season-range and character selection, derives the
 * per-character word/phrase frequencies used by the word clouds, and loads the
 * aggregated transcript JSON to construct each chart (Barchart, StackedBarchart,
 * WordLengthHisto, ArcDiagram). The chart classes themselves live in their own
 * files; this module orchestrates them and keeps every view in sync with the
 * current selection.
 */
...
// Re-render the conversation arc whenever the season dropdown changes.
