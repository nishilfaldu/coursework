/**
 * Leaflet map view. Plots each sighting as a point, supports color-by
 *  attribute, switchable base layers, and rectangular area-select brushing
 *  that filters the rest of the dashboard.
 */
const colorSchemes = {
  year: [
  ...
  month: [
    { label: "January", color: "#33C3F0" },
    { label: "February", color: "#2E5EAA" },
    { label: "March", color: "#A8DADC" },
    { label: "April", color: "#F4A261" },
    { label: "May", color: "#E9C46A" },
    { label: "June", color: "#2A9D8F" },
    { label: "July", color: "#F4A261" },
    { label: "August", color: "#E76F51" },
    { label: "September", color: "#2A9D8F" },
    { label: "October", color: "#264653" },
    { label: "November", color: "#1D3557" },
    { label: "December", color: "#457B9D" },
  ],
  "time-of day": [
    { label: "Night", color: "#023047" },
    { label: "Morning", color: "#F4A261" },
    { label: "Afternoon", color: "#2A9D8F" },
    { label: "Evening", color: "#33C3F0" },
  ],
  "ufo-shape": [
    { label: "Cylinder", color: "#ffadad" },
    { label: "Light", color: "#ffd6a5" },
    { label: "Circle", color: "#fdffb6" },
    { label: "Sphere", color: "#caffbf" },
    { label: "Disk", color: "#9bf6ff" },
    { label: "Fireball", color: "#a0c4ff" },
    { label: "Unknown", color: "#bdb2ff" },
    { label: "Oval", color: "#ffc6ff" },
    { label: "Other", color: "#fffffc" },
    { label: "Cigar", color: "#ffaaaa" },
    { label: "Rectangle", color: "#d0f4de" },
    { label: "Chevron", color: "#fde2e4" },
    { label: "Triangle", color: "#fad2e1" },
    { label: "Formation", color: "#c5dedd" },
    { label: "Delta", color: "#dbe7e4" },
    { label: "Changing", color: "#f0efeb" },
    { label: "Egg", color: "#d6e2e9" },
    { label: "Diamond", color: "#bcd4e6" },
    { label: "Flash", color: "#99c1de" },
    { label: "Teardrop", color: "#a2d2ff" },
    { label: "Cone", color: "#8d99ae" },
    { label: "Cross", color: "#edf2f4" },
    { label: "Pyramid", color: "#e29578" },
    { label: "Round", color: "#e85d04" },
    { label: "Crescent", color: "#dc2f02" },
    { label: "Flare", color: "#e63946" },
    { label: "Hexagon", color: "#f1faee" },
    { label: "Dome", color: "#a8dadc" },
  ...
  initVis() {
    ...
    vis.Dots = vis.svg
      ...
      .on("mouseover", function (event, d) {
        ...
        //create a tool tip
        d3.select("#tooltip").style("opacity", 1).style("z-index", 1000000)
          .html(`
      ...
      switch (category) {
        ...
        case "time-of day":
          ...
          if (hour < 6)
            ...
            return "#F4A261"; // Morning
          else if (hour < 18)
            return "#2A9D8F"; // Afternoon
