/**
 * Entry point. Loads the UFO sightings CSV, wires up the dropdown
 *  filters, search and brushing, and instantiates every chart + the map.
 *  All views share a CentralDataStore so interactions stay in sync.
 */
